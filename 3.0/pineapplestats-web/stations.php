...
<body>
	<div class="navbar navbar navbar-fixed-top">
	        ...
	        <div class="container">
	          ...
	          <div class="nav-collapse collapse">
				  <ul class="nav">
					  ...
					  <li class="active"><a href="./stations.php"><i class="icon-leaf"></i>&nbsp;Stations</a></li>
	    ...
	    <div class="container well">
			...
			<div class="row">
				<div class="span12">
					<div id="chart_mac" style="width:100%; height:400px;"></div>
				</div>
			</div>
			    ...
			    $('#chart_mac').highcharts({
		            ...
		            plotOptions: {
						...
						series: {
			                ...
			                point: {
			                    events: {
			                        click: function() {
										oTable.fnReloadAjax('getdata.php?Station_MAC='+this.name);
			                        }
			                    }
			                }
			            }
					...
					series: [{
						...
						<?php
							...
							$i=1; $all=count(array_count_values($mac));
							foreach(array_count_values($mac) as $key => $value)
							{
								echo "['".$key."', ".$value."]";
								if($i != $all) echo ",";
