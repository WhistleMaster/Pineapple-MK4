...
<script type="text/javascript" src="js/trapcookies.js"></script>
<link rel="stylesheet" type="text/css" href="css/trapcookies.css" />
...
<script type="text/javascript" charset="utf-8">
	$(document).ready( function () { init(); <?php if ($is_ngrep_running) echo "refresh();"; ?> });	
</script>
...
if($is_ngrep_installed)
{
	...
	if($is_landing_installed)
	{
		...
		echo " | <a id=\"landing_link\" href=\"javascript:landing_toggle('uninstall');\"><strong>Uninstall</strong></a><br />";
	}
	else
	{
		echo "Landing Page <span id=\"landing_status\"><font color=\"red\"><strong>not installed</strong></font></span>";
		echo " | <a id=\"landing_link\" href=\"javascript:landing_toggle('install');\"><strong>Install</strong></a><br />";
	} 
...
<div id="Landing">
	[<a href="javascript:update_conf($('#landing').val(), 'landing');">Save</a>]<br /><br />
	<?php
		echo "<textarea id='landing' name='landing' cols='85' rows='29'>"; echo file_get_contents($landing_path); echo "</textarea>";
	?>
</div>
