...
{	
	...
	echo '<td><input type="text" id="speed" name="speed" value="'.$speed_conf.'" size="5"> (Leave empty for default)</td></tr>';
	echo "<tr><td>Channel (e.g. 10)</td>";
	echo '<td><input type="text" id="channel" name="channel" value="'.$channel_conf.'" size="5"> (Leave empty for default)</td></tr>';
	echo "<tr><td>Options</td>";
	echo '<td><input type="text" id="options" name="options" value="'.$options_conf.'" size="15"></td></tr>';
	echo '</table>';
	echo "</form>";
